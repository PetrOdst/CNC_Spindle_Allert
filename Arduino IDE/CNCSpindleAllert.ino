...
void firstpage() {
  ...
  // SerialMon.println(curentt-sleept);
  ...
  // myGLCD.drawCircle(0, 120, 155, TFT_CYAN);
  // myGLCD.drawCircle(320, 120, 155, TFT_CYAN);
...
//else{
//    myGLCD.setTextSize(1);
//    myGLCD.drawString("Napeti na vretenu:", 60, 20, 2);
//    myGLCD.setTextSize(2);
//    myGLCD.drawString(String("nula") + " V", 60, 50, 2);
//    myGLCD.drawLine(0, 90, 240, 90,TFT_CYAN);
//    myGLCD.setTextSize(1);
//    myGLCD.drawString("Proud na vretenu:" , 60, 110, 2);
//    myGLCD.setTextSize(2);
//    myGLCD.drawString(String("nula") + " A", 60, 140, 2);
//     myGLCD.drawLine(0, 180, 240, 180,TFT_CYAN);
//  }
if (active){
    myGLCD.setTextSize(1);
    ...
    if (paused){
      //warning message
      pauzadur = millis() - pauzastart;
      unsigned long currentMillis = pauzadur;
      ...
      myGLCD.drawString(String(maxcur) , 10, 190, 2); 
      myGLCD.drawString(String(spindle) , 220, 190, 2);
      myGLCD.drawString("Pauza trva :" , 80, 200, 2);
      myGLCD.setTextSize(3);
      myGLCD.drawString(String(hours) + ":"+ String(minutes) + ":"+ String(seconds), 90, 220, 2);
      } else {
      myGLCD.setTextColor(TFT_CYAN,TFT_BLACK );
      myGLCD.drawString(String("Nedeje se nic."), 42, 217, 2);
      myGLCD.setTextSize(1);
      if (spindle){
        myGLCD.drawString("Tool spins", 170, 190, 2);
        }else{
        myGLCD.drawString("Tool stops" , 170, 190, 2);   
        }
     // myGLCD.drawString(String(spindle) , 220, 190, 2);
      myGLCD.drawString("I max (so far): " + String(maxcur) + "A" , 2, 190, 2);    
      ...
      myGLCD.setTextSize(2);
      myGLCD.setTextColor(TFT_CYAN,TFT_BLACK );
      myGLCD.drawString(String("Nedeje se nic."), 42, 222, 2);
      myGLCD.setTextSize(1);
      if (spindle){
        myGLCD.drawString("Tool spins", 170, 190, 2);
        }else{
...
if (current > maxcurrent ){
  duvod = "Proud byl vetsi nez mel" + String(current);
  pausedd();
  } 

if (current < mincurrent ){
  duvod = "Proud byl mensi nez mel" + String(current);
  pausedd();
  } 
}
  myGLCD.setTextSize(2);
...
void pausedd() {
  ...
  // if (!paused){
   ...
   digitalWrite(SPINDLE_RELE_PIN,HIGH);
   spindle = false;
   myGLCD.fillRect(2, 190, 236,100,TFT_RED);
   myGLCD.setTextColor(TFT_CYAN,TFT_RED );
   myGLCD.setTextSize(1);
       
   myGLCD.drawString(String(duvod) , 10, 190, 2);
   myGLCD.setTextSize(2);
